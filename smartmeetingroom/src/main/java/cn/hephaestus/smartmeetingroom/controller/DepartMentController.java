...
public class DepartMentController {
    ...
    public RetJson getDepartmentsByOid(){
        return RetJson.success("Departments",departmentService.getDepartmentList(oid));
    }
    ...
    public RetJson getDepartment(Integer did){
        ...
        return RetJson.success("Departments",department);
    }
    ...
    public RetJson insertDepartment(Department department){
        ...
        if(departmentService.addDepartment(department)){
            return RetJson.success("did",department.getDepartmentId());
        }
