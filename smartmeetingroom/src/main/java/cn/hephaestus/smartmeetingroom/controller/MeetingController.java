...
public class MeetingController {
    ...
    public RetJson addMeetingParticipant(Integer reserveId, HttpServletRequest request){
        ...
        return RetJson.success("participants",set);
    }
    ...
    public RetJson getMeetingInfoByCondition(String date, String rid, String did){
        System.out.println("getMeetingInfoByCondition++++++++++");
        Integer myRid=null,myDid=null;
        try {
            if (!rid.equals("null")){
                myRid=Integer.valueOf(rid);
            }

            if (!did.equals("null")){
                myDid=Integer.valueOf(did);
            }
        }catch (Exception e){
        ...
        List<ReserveInfoViewObject> list = reserveInfoService.getReserveInfoViewObjectByCondition(myDate,myRid,myDid,userInfo.getOid());
        return RetJson.success("list",list);
    }
    ...
    public RetJson checkInParticipant(Integer mid){
        ...
        return RetJson.success("situation",res);
    }
        ...
        for (int i=3;i>=1;i--){
            ...
            if (temp.size()==0){
                ...
                if (reserveInfoService.updateReserveInfo(reserveInfo)){
                    ...
                    return RetJson.success("delay",delay/(1000*60));
                }
            }
        }
    ...
    public RetJson getCountOfDepartmentMeeting(Integer type,Integer year,Integer month){
        ...
        return RetJson.success("count",count);
    }
    ...
    public RetJson getCountOfMeeting(@DateTimeFormat(pattern = "yyyy-MM-dd") Date date){
        ...
        return RetJson.success("count",map);
    }
}
